...
DISABLED = 0x04    # probe disabled by the observers (no star present, double star, wrong position)
...
class GProbe(object):
    ...
    def ugriz(self, value):
        ...
        Coefficient are from Masayuki, Gunn&Strkyer stds observed through
        modeled guider & g,r passbands
        """
        self._ugriz = value
