...
class TestExpose(guiderTester.GuiderThreadTester,unittest.TestCase):
    ...
    def test_flat_5(self):
        self._expose(5, expType='flat', cartridge=10, expect={'expType':guiderActor.Msg.FLAT_FINISHED})
    def test_dark_10_stack_9(self):
        self._expose(10, stack=9, expType='dark', expect={'expType':guiderActor.Msg.DARK_FINISHED})
