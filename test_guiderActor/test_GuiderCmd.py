...
class TestFakeCartridge(GuiderCmdTester,unittest.TestCase):
                ...
                if gprobeGot.id == gprobeId:
                    for attr in self.testAttrs:
                        if attr in gprobeExpect:
                            if type(getattr(gprobeGot, attr)) == str:
                                self.assertEqual(getattr(gprobeGot, attr), gprobeExpect.get(attr, None), "{} for gprobeId: {}".format(attr,gprobeId))
                            else:
                                # NOTE: grumble, float comparisons, grumble...
                                self.assertAlmostEqual(getattr(gprobeGot, attr), gprobeExpect.get(attr, None), 6, msg="{} for gprobeId: {}".format(attr,gprobeId))
    ...
    def test_fakeCartridge_8641(self):
        ...
        expect = {
            ...
            'fiberPos':1,
            'gprobes':gprobes}
        self._fakeCartridge('plate={plate} pointing={pointing} fiberPos={fiberPos}'.format(**expect),expect)

    def test_fakeCartridge_8646(self):
        gprobes = {
            1: {"ra": 7.713199, "dec": -29.765444, "xFocal": -61.316109, "yFocal":253.6546,  "xCenter": 170.5, "yCenter": 412.5, "radius": 8.5, "rotation": 272.0, "xFerruleOffset":  -4.5, "yFerruleOffset":   3.2, "focusOffset": 400.0,  "fiber_type": 'GUIDE'},
            2: {"ra": 7.865471, "dec":-29.11857, "xFocal": -105.42248, "yFocal":39.318875,   "xCenter": 140.5, "yCenter": 264.5, "radius": 8.5, "rotation": 268.0, "xFerruleOffset":  -6.9, "yFerruleOffset":   0.3, "focusOffset":   0.0,  "fiber_type": 'GUIDE'},
            3: {"ra": 7.7258693, "dec":-28.697817, "xFocal": -65.42454, "yFocal":-99.718591, "xCenter": 154.5, "yCenter": 90.5 , "radius": 27, "rotation": 132.0, "xFerruleOffset":   9.2, "yFerruleOffset":   1.7, "focusOffset":   0.0,  "fiber_type": 'ACQUIRE'},
            4: {"ra": 7.9546143, "dec":-28.722066, "xFocal": -131.74361, "yFocal":-91.585178,"xCenter": 254.5, "yCenter": 76.5 , "radius": 8.5, "rotation": 278.0, "xFerruleOffset":  -6.6, "yFerruleOffset":   4.2, "focusOffset": -400.0, "fiber_type": 'GUIDE'},
            5: {"ra": 7.563513, "dec":-28.37965, "xFocal": -18.484631, "yFocal":-205.19272,  "xCenter": 213.5, "yCenter": 245.5, "radius": 8.5, "rotation": 271.0, "xFerruleOffset":  -4.9, "yFerruleOffset":   8.8, "focusOffset":   0.0,  "fiber_type": 'GUIDE'},
            6: {"ra": 8.091459, "dec":-29.331564, "xFocal": -170.55195, "yFocal":110.10227,  "xCenter": 236.5, "yCenter": 162.5, "radius": 8.5, "rotation": 251.0, "xFerruleOffset":  14.9, "yFerruleOffset":  -1.4, "focusOffset": -400.0, "fiber_type": 'GUIDE'},
            7: {"ra": 8.109592, "dec":-29.023161, "xFocal": -176.20022, "yFocal":8.1160002,  "xCenter": 90.5 , "yCenter": 182.5, "radius": 8.5, "rotation": 267.0, "xFerruleOffset":   3.1, "yFerruleOffset":   6.4, "focusOffset":   0.0,  "fiber_type": 'GUIDE'},
            8: {"ra": 8.0936182, "dec":-28.763194,"xFocal": -172.06145, "yFocal":-77.863252, "xCenter": 192.5, "yCenter": 328.5, "radius": 8.5, "rotation": 344.0, "xFerruleOffset":  -0.8, "yFerruleOffset":  -1.1, "focusOffset": 400.0,  "fiber_type": 'GUIDE'},
            9: {"ra": 7.0428383, "dec":-28.166214, "xFocal": 133.73854, "yFocal":-276.40956, "xCenter": 268.5, "yCenter": 347.5, "radius": 8.5, "rotation": 264.0, "xFerruleOffset":  -9.3, "yFerruleOffset":  -0.8, "focusOffset": 400.0,  "fiber_type": 'GUIDE'},
            10: {"ra": 6.955436, "dec":-28.951372, "xFocal": 157.45553, "yFocal":-15.700456, "xCenter": 289.5, "yCenter": 264.5, "radius": 8.5, "rotation": 273.0, "xFerruleOffset":  -7.1, "yFerruleOffset":   8.2, "focusOffset":   0.0,  "fiber_type": 'GUIDE'},
            11: {"ra": 7.1099969, "dec":-29.118803, "xFocal": 112.50913, "yFocal":39.422145, "xCenter": 418.5, "yCenter": 156.5, "radius": 27, "rotation": 90.0, "xFerruleOffset":   -6.6, "yFerruleOffset":  -2.6, "focusOffset":   0.0,  "fiber_type": 'ACQUIRE'},
            12: {"ra": 7.1206053, "dec":-29.200405, "xFocal": 109.37635, "yFocal":66.367385, "xCenter": 308.5, "yCenter": 182.5, "radius": 8.5, "rotation": 245.0, "xFerruleOffset": -10.6, "yFerruleOffset":  -3.5, "focusOffset": -400.0, "fiber_type": 'GUIDE'},
            13: {"ra": 7.1268997, "dec":-29.703818, "xFocal": 107.35518, "yFocal":233.32247, "xCenter": 324.5, "yCenter": 402.5, "radius": 8.5, "rotation": 224.0, "xFerruleOffset":  -7.5, "yFerruleOffset":   6.6, "focusOffset":   0.0,  "fiber_type": 'GUIDE'},
            14: {"ra": 6.524485, "dec":-28.842894, "xFocal": 283.34771, "yFocal":-50.92314,  "xCenter": 329.5, "yCenter": 97.5 , "radius": 8.5, "rotation": 253.0, "xFerruleOffset":  -8.3, "yFerruleOffset":   5.0, "focusOffset": -400.0, "fiber_type": 'GUIDE'},
            15: {"ra": 6.444669, "dec":-28.884399, "xFocal": 306.63774, "yFocal":-36.988933, "xCenter": 407.5, "yCenter": 354.5, "radius": 8.5, "rotation": 198.0, "xFerruleOffset":  -1.1, "yFerruleOffset":  -0.9, "focusOffset":   0.0, "fiber_type": 'GUIDE'},
            16: {"ra": 6.4775823, "dec":-29.128048, "xFocal": 296.27414, "yFocal":43.766755, "xCenter": 293.5, "yCenter": 428.0, "radius": 8.5, "rotation":   0.0, "xFerruleOffset":  -6.5, "yFerruleOffset": -12.7, "focusOffset": 400.0, "fiber_type": 'GUIDE'},
        }
